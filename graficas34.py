...
plt.bar(range(1,6),plot1,color='black', align='center')
plt.xlabel('Pelicula', color="orange")
plt.ylabel('Rating', color="orange")
plt.title('Gráfica TOP-5', color="red")
plt.tight_layout()
print(name)
print(tcinco)
plt.savefig("tcinco.png")
...
plt.bar(range(1,21),plot2,color='black',align='center')
plt.xlabel('Peliculas', color="orange")
plt.ylabel('Rating', color="orange")
plt.title('Gráfica TOP-20', color="red")
plt.tight_layout()
plt.savefig("tveinte.png")
